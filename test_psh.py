...
if __name__ == '__main__':
                ...
                with gr.Tab("出院小结") as Tab3:
                    with gr.Row():           
                        with gr.Column(scale=2):
                            ...
                            html_content_doctor= gr.HTML(value="Callable",elem_classes='container1',label='医生结果') 
                        with gr.Column(scale=2):
    ...
    demo.queue().launch(show_api= False,share=False, server_name="0.0.0.0", server_port=7896, inbrowser=False)
