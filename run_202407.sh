...
# keshi_list=('ruxianwaike' 'zhongliuke' 'yanke' 'zhongyike' 'neifenmi' 'xiaohuaneike' 'huxineike' 'shenjingneike' 'shenzangneike' 'fuke' 'jiazhuangxianxueguanwaike' 'xiaoerke' 'erbihouke' 'shenjingwaike' 'weichangwaike')
keshi_list=('ruxianwaike') # zhongliuke # ruxianwaike
# zylsh='19122600000464'  
...
do  
    ...
    CUDA_VISIBLE_DEVICES=3 python pipeline_wjc.py $ins_out_dir $keshi $zylsh $generate_out_dir $model_path $gpu

    # 后处理
    echo "后处理"
    # CUDA_VISIBLE_DEVICES=0 python postprocess_wjc.py $generate_out_dir $keshi $zylsh $generate_out_dir
