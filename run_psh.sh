...
end_num=50
zylsh='-1'      #如果设置为-1，一个科室下所有病例都生成;设置成-2，处理start_num到end_num个病人的csv文件
...
do  
    ...
    # 后处理
    echo "后处理"
    CUDA_VISIBLE_DEVICES=6 python postprocess_wjc.py $generate_out_dir $keshi $zylsh $generate_out_dir
